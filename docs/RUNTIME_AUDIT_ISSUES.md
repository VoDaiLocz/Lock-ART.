...
- **Severity:** High
- **Affected files:**  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/cli.py` (batch command)  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/services/protection.py` (`protect_directory`)
...
- **Severity:** Medium
- **Affected files:**  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/services/protection.py` (`_scan_directory_jobs`, `protect_directory`)  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/cli.py` (batch command)
...
- **Severity:** Medium
- **Affected files:**  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/services/protection.py` (`protect_file_adaptive`)  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/cli.py` (protect report serialization)
...
- **Severity:** Medium
- **Affected files:**  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/services/protection.py` (`_collect_benchmark_entries`)  
  - `/home/runner/work/Lock-ART./Lock-ART./src/auralock/cli.py` (benchmark command behavior)
